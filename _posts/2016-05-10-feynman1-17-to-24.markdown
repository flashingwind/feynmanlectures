...
$$
X_{CM}=\frac{\sum m_i x_i}{\sum m_i}=\frac{m_i\sum x_i}{N m_i}=\frac{\sum x_i}{N}
$$

#### (合成)

$$
MX_{CM}=\sum_A m_i x_i +\sum_B m_i x_i=M_A X_A + M_B X_B
$$
...
$$
I = \frac{2\frac{M}{2}\left(\frac{L}{2}\right)^2}{3}\\
= \frac{ML^2}{12}
$$
